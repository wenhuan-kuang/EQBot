...
class Location(gym.Env):
	def __init__(self):
                ...
                self.amp_3d,self.evxs,self.evys,self.evzs,self.evids,self.mask,self.rxs,self.rys = \
                          self.load_data(mypath='/home/kuangwh/RL_location/Deep-RL-Keras-master-Demo/demo_data',\
                          sgyf1=2,sgyt1=2,step1=1,shuffle='False')
                # load in traveltime table
                self.tt_tp = self.load_3Dttfile(mypath='/home/kuangwh/RL_location/Deep-RL-Keras-master-Demo/demo_data')
                # for testing
